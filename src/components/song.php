...
class song
{
    ...
    public function toHtml(): string{
        ...
        if($_SESSION["user"]["status"] == "ADMIN"){
            $additional_elements = "
                <form action='managesong.php' method='post'>
                    <input type='hidden' name='song_id' value='".$this->id."'>
                    <input type='submit' value='Rimuovi'>
                </form>
                <form action='managesong.php' method='get'>
                    <input type='hidden' name='song_id' value='".$this->id."'>
        ...
        return "
            <li>
                <img src='assets/images/".$this->graphic_file_name."' alt='Copertina della canzone ".$this->name."'>
                <p>".$this->name."</p>
                <a href='artist.php?id=".$this->producer."' aria-label='Vai alla pagina personale di ".$this->producer_name."'>".$this->producer_name."</a>
                <audio controls>
                    <source src='assets/Audio/".$this->audio_file_name."' type='audio/mpeg'>
